...
class CompanySuccessAPITestCase(TestCase):
    ...
    def test_company_api_create(self):
        ...
        company_dict: dict = response.data  # type: ignore
        ...
        self.assertTrue(len(self.company.slug) < len(company_dict["slug"]))
    ...
    def test_company_api_list(self):
        ...
        self.assertTrue(len(company_dict["results"]) > 0)

    def test_company_api_delete(self):
        """Test company api delete"""

        response = self.client.delete(
            f"{COMPANY_API_URL}/{self.company.slug}/disable/",
        )
...
class CompanyFailureAPITestCase(TestCase):
    ...
    def test_company_api_create(self):
        ...
        error: dict = response.data  # type: ignore
        self.assertTrue("contact_email" in error["error"].lower())
    ...
    def test_company_api_retrieve(self):
        ...
        self.assertIn("error", company_dict)
    ...
    def test_company_api_list(self):
        ...
        self.assertTrue("detail" in company_dict)
