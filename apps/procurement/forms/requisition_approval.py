...
class RequisitionApprovalForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if (
            ...
            self.fields[
                "finance_requisition_approval"
            ].queryset = requisition_approvals.FinanceRequisitionApproval.objects.filter(
        ...
        if (
            ...
            ].queryset = requisition_approvals.ProcurementRequisitionApproval.objects.filter(
        ...
        if (
            ...
            self.fields[
                "department_approval"
            ].queryset = requisition_approvals.DepartmentRequisitionApproval.objects.filter(
                department_req_approval_set__isnull=True
            )
        if "unit_approval" in self.fields and not self.instance.unit_approval:
            self.fields[
                "unit_approval"
            ].queryset = requisition_approvals.UnitRequisitionApproval.objects.filter(
