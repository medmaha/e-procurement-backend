    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('APPROVAL LEVEL', 'Approval Level'), ('PUBLISH LEVEL', 'Publish Level'), ('QUOTATION LEVEL', 'Quotation Level'), ('CONTRACT LEVEL', 'Contract Level'), ('PURCHASE ORDER LEVEL', 'Purchase Order Level'), ('INVOICE LEVEL', 'Invoice Level')], default='APPROVAL LEVEL', max_length=50)),
