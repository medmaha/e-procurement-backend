...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='officer',
            field=models.ForeignKey(blank=True, help_text='Authorizes this instance', null=True, on_delete=django.db.models.deletion.SET_NULL, to='organization.staff'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='rfqitem',
            name='rfq',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rfq_items_set', to='procurement.rfq'),
        ),
        migrations.AddField(
