...
from .views.requisitions.retrieve import RequisitionGetAPIView
...
from .views.rfq.retrieve import RfqGetAPIView
...
from .views.rfq.evaluation.retrieve import RFQEvaluationGetAPIView

from .views.rfq.responses.reject import QuotationRespondRejectView
from .views.rfq.responses.retrieve import QuotationRespondGetAPIView
...
from .views.purchase_order.retrieve import PurchaseOrderGetAPIView
...
from .views.form101.view import Form101GetAPIView
...
urlpatterns = [
    ...
    #
    # Requisition
    path("form101/retrieve/", Form101GetAPIView.as_view()),
    ...
    path("requisitions/<slug>/", RequisitionGetAPIView.as_view()),
    ...
    path("rfq/responses/<slug>/", QuotationRespondGetAPIView.as_view()),
    #
    # RFQ Evaluation
    path("rfq/evaluation/create/", RFQEvaluationCreateView.as_view()),
    path("rfq/evaluation/remove/", RFQEvaluationRemoveView.as_view()),
    path("rfq/evaluation/retrieve/<rfq_id>/", RFQEvaluationGetAPIView.as_view()),
    #
    # RFQ Contracts
    ...
    path("rfq/<slug>/", RfqGetAPIView.as_view()),
    ...
    path("quotations/respond/retrieve/<id>/", QuotationRespondGetAPIView.as_view()),
    path("quotations/respond/", QuotationRespondListView.as_view()),
    #
    path("purchase-orders/retrieve/<id>/", PurchaseOrderGetAPIView.as_view()),
