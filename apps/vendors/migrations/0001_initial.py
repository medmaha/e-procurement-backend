    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(null=True, upload_to=apps.vendors.models.vendor.upload_company_logo)),
                ...
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.address')),
                ('certificates', models.ManyToManyField(related_name='vendors', to='vendors.certificate')),
